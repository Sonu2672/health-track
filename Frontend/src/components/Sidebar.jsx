    ...
    <aside className={`sidebar ${isOpen ? "open" : ""}`}>
      ...
      <nav className="sidebar-nav">
        <div className="nav-item measure-item">
          <Plus size={18} />
          <Link to="/patient">New Measurement</Link>
        </div>
        ...
        <div className="nav-item">
          <HeartPulse size={17} />
          <Link to="/monitor">Health Monitor</Link>
        </div>
        ...
        <div className="nav-item">
          <CloudSun size={17} />
          <Link to="/disaster">Disaster Alert 🚨</Link>
        </div>
      ...
      <div className="sidebar-bottom">
        <div className="safe-card">
          <div className="safe-title">Stay Safe, Stay Healthy</div>
          <p>
