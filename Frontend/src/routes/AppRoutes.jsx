...
function AppRoutes() {
   ...
   // OneSignal Initialization & Player ID Sync Effect
   useEffect(() => {
     const initOneSignal = async () => {
       try {
         ...
         // User ka Player ID fetch karke backend bhejna
         ...
         if (playerId) {
           ...
           await fetch("https://healthtrackb.onrender.com/api/users/save-onesignal-id", {
             ...
             credentials: "include", // Cookies / session ke liye zaroori hai
             body: JSON.stringify({ playerId })
           });
         }
       } catch (error) {
         console.error("OneSignal Initialization or Player ID Error:", error);
       }
     };
