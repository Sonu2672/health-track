...
function RiskAnalysis() {
  ...
  // ==========================================
  // DEFAULT RISK STATE
  // Backend response aane tak ye values dikhenge
  // ==========================================
  const [riskScore, setRiskScore] = useState(0);
  const [riskLevel, setRiskLevel] = useState("Low Risk");
  ...
  const evaluateSensorRisks = (data) => {
    ...
    // Body Temp Conversion to °F
    const bodyTempF = data.temp
      ? (data.temp * 1.8 + 32).toFixed(1)
      : 0;
  ...
  useEffect(() => {
    const Hdata = async () => {
      try {
        ...
        // Backend AI Risk Score, otherwise calculated score
        setRiskScore(data.riskScore ?? calculatedScore);

        // Backend Risk Level, otherwise calculated level
        setRiskLevel(data.riskLevel ?? level);

        // ==========================================
        // BACKEND RECOMMENDATIONS
        // Agar backend recommendations hain
        // to wahi show hongi
        // ==========================================
        setRecom(
        ...
        // default recommendations remain
        setRecom(defaultRecommendations);
      }
    };
        ...
        <section className="risk-summary">
          ...
          <div className="score-section">
            ...
            <div className="risk-gauge">
              ...
              <div
                className={`gauge-label ${getRiskClass()}`}
              >
                {riskLevel}
              </div>
          ...
          <div className="risk-level-section">
            ...
            <p>
              AI model analyzes your health and environmental
              parameters to estimate the current health risk.
            </p>
